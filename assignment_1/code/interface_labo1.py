...
def find_circle(image_path, inverse_ratio=1, min_distance=10, canny_threshold=30, accumulator_threshold=30, min_radius=0, max_radius=0):
    ...
    circles = cv2.HoughCircles(gray, cv2.HOUGH_GRADIENT, inverse_ratio, min_distance, param1=canny_threshold, param2=accumulator_threshold, minRadius=2, maxRadius=100)
